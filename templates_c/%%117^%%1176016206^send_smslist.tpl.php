<?php /* Smarty version 2.6.2, created on 2016-10-07 09:52:20
         compiled from send_smslist.tpl */ ?>
					...
					<!-- form start -->
						...
						<div class="box-body">
							...
							<div class="form-group col-lg-6">
								...
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									...
									<select name="customer_type" id="customer_type" class="form-control container_type_customer" onchange="getSMScustomerslist(this.value)"  style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;' >
										<option value="0" <?php if ($this->_tpl_vars['customer_type'] == '0'): ?> selected="selected"<?php endif; ?>>Select Recipients</option>
										<option value="over_due_customer"  <?php if ($this->_tpl_vars['customer_type'] == 'over_due_customer'): ?> selected="selected"<?php endif; ?>>Overdue Customers</option>
										<option value="all_customer" <?php if ($this->_tpl_vars['customer_type'] == 'all_customer'): ?> selected="selected"<?php endif; ?>>All Customers</option>
										<option value="selected_customer" <?php if ($this->_tpl_vars['customer_type'] == 'selected_customer'): ?> selected="selected"<?php endif; ?>>Specific customers</option>									
									</select>
								</div>	
							</div>
							...
							<div class="form-group col-lg-12" style="display:none">
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									<label for="exampleInputEmail1">Select - <?php echo $this->_tpl_vars['customer_type']; ?>
 - Customers:</label>
								</div>	
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
						...
						<?php if ($this->_tpl_vars['customer_type'] != 'over_due_customer'): ?>
							<div class="form-group col-lg-12">
								...
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									<select id="lstCustomer" name="lstCustomer" multiple="multiple" style="overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;">
										<?php if (isset($this->_sections['sms'])) unset($this->_sections['sms']);
$this->_sections['sms']['name'] = 'sms';
$this->_sections['sms']['loop'] = is_array($_loop=$this->_tpl_vars['ViewSMSCustomerList']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['sms']['show'] = true;
$this->_sections['sms']['max'] = $this->_sections['sms']['loop'];
$this->_sections['sms']['step'] = 1;
$this->_sections['sms']['start'] = $this->_sections['sms']['step'] > 0 ? 0 : $this->_sections['sms']['loop']-1;
if ($this->_sections['sms']['show']) {
    $this->_sections['sms']['total'] = $this->_sections['sms']['loop'];
    if ($this->_sections['sms']['total'] == 0)
        $this->_sections['sms']['show'] = false;
} else
    $this->_sections['sms']['total'] = 0;
if ($this->_sections['sms']['show']):

            for ($this->_sections['sms']['index'] = $this->_sections['sms']['start'], $this->_sections['sms']['iteration'] = 1;
                 $this->_sections['sms']['iteration'] <= $this->_sections['sms']['total'];
                 $this->_sections['sms']['index'] += $this->_sections['sms']['step'], $this->_sections['sms']['iteration']++):
$this->_sections['sms']['rownum'] = $this->_sections['sms']['iteration'];
$this->_sections['sms']['index_prev'] = $this->_sections['sms']['index'] - $this->_sections['sms']['step'];
$this->_sections['sms']['index_next'] = $this->_sections['sms']['index'] + $this->_sections['sms']['step'];
$this->_sections['sms']['first']      = ($this->_sections['sms']['iteration'] == 1);
$this->_sections['sms']['last']       = ($this->_sections['sms']['iteration'] == $this->_sections['sms']['total']);
?>
											<option value="<?php echo $this->_tpl_vars['ViewSMSCustomerList'][$this->_sections['sms']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['ViewSMSCustomerList'][$this->_sections['sms']['index']]['first_name']; ?>
</option>
										<?php endfor; endif; ?>									
							  </select>
								</div>	
						...
						<div class="form-group col-lg-6">	
							<div class="bootstrap-timepicker">
								...
								<div class="form-group">
									...
									<input type="text" name="time_value" id="time_value" value="<?php echo $this->_tpl_vars['ViewSMSCustomerList'][0]['time_to_send']; ?>
							...
							<div class="form-group col-lg-6">
								...
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									<select name="get_repetition" id="get_repetition" onchange="getResults(this.value)" class="form-control container_type_customer" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;' >
										<option value="0" <?php if ($this->_tpl_vars['daterange'] == '0'): ?> selected="selected"<?php endif; ?>>Select Repetition</option>
										<option value="daily"  <?php if ($this->_tpl_vars['daterange'] == 'overdue_customers'): ?> selected="selected"<?php endif; ?>>Daily</option>
										<option value="weekly" <?php if ($this->_tpl_vars['daterange'] == 'all_customers'): ?> selected="selected"<?php endif; ?>>Weekly</option>
										<option value="monthly" <?php if ($this->_tpl_vars['daterange'] == 'specific_customers'): ?> selected="selected"<?php endif; ?>>Monthly</option>									
									</select>
								</div>	
							</div>
...
<script src="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
plugins/timepicker/bootstrap-timepicker.min.js" type="text/javascript"></script>
