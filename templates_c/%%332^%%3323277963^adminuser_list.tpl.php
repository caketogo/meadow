<?php /* Smarty version 2.6.2, created on 2016-10-07 12:24:57
         compiled from adminuser_list.tpl */ ?>
...
add_adminuser.php" title="Add Admin User"  class="btn bg-primary btn-primary margin">
									Add Admin User
						</a>
						<!--<a class="new_admin_class" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
add_adminuser.php" title="Add Admin User"><i class="glyphicon glyphicon-user" style="font-size:28px;color:green;"></i></a>
						<a class="new_admin_class" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
add_adminuser.php" title="Import Container"><i class="glyphicon glyphicon-import" style="font-size:28px;color:green;"></i></a>-->
						</div>	
						</div>
					</div>		
				...
				<!-- <div class="box-header">
					...
					<div class="col-md-6">
					   <a href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
add_adminuser.php" title="Add Admin User"><button class="btn btn-success"><i class="fa fa-plus"></i></button></a>
                	</div>
                </div>-->
