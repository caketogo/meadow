<?php /* Smarty version 2.6.2, created on 2016-09-09 05:52:37
         compiled from create_change_terms_condition.tpl */ ?>
					...
					<form name="frmsettings" id="frmsettings" role="form" method="post" onsubmit="return checkValidation();">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<div class="col-md-12">
									<label for="exampleInputEmail1">Add Terms and conditions: </label>
								</div>	
								<div class="col-md-6">
									<textarea class="form-control" rows="8" id="terms_condition" name="terms_condition"></textarea>
								</div>	
							</div>
