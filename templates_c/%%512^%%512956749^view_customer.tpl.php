<?php /* Smarty version 2.6.2, created on 2016-10-07 16:44:50
         compiled from view_customer.tpl */ ?>
...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<!--notes_list.php?customer_id=<?php echo $this->_tpl_vars['CustomerDetails'][0]['id']; ?>
-->
		<form name="customer_tab_form" id="customer_tab_form" role="form" action="" method="post">
			...
			<input type="hidden" name="customer_id" id="customer_id" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['id']; ?>
"  /> 						
					...
					<!-- form start -->
						...
						<div class="box-body">
							...
							<div class="form-group col-lg-6">
								...
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									<input type="text" name="first_name" id="first_name" class="form-control" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['first_name']; ?>
" style='overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
							...
							<div class="form-group col-lg-6">
								...
								<div class="col-lg-12 col-md-12" style="padding-left:0px; padding-right:0px;">
									<input type="text" name="sur_name" id="sur_name" class="form-control" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['sur_name']; ?>
"  style='overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="address_line1" id="address_line1" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['address1']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="address_line2" id="address_line2" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['address2']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="address_line3" id="address_line3" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['address3']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="postcode" id="postcode" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['post_code']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
							
							
							<?php if ($this->_tpl_vars['CustomerDetails'][0]['invoice_status'] == 'yes'): ?>
							...
							<div class="form-group" id="invoice_address_section">			
									...
									<div class="col-md-12">
										<input type="text" name="invoice_address_line1"  disabled="disabled" id="invoice_address_line1" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['invoice_address_line1']; ?>
" class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
									</div>	
									...
									<div class="col-md-12">
										<input type="text" name="invoice_address_line2"  disabled="disabled" id="invoice_address_line2" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['invoice_address_line2']; ?>
" class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
									</div>										
									...
									<div class="col-md-12">
										<input type="text" name="invoice_address_line3"  disabled="disabled" id="invoice_address_line3" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['invoice_address_line3']; ?>
" class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
									</div>		
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" name="invoice_postcode"  disabled="disabled" id="invoice_postcode" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['invoice_postcode']; ?>
" class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
										</div>	
									</div>																	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="mobile_number" id="mobile_number" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['mobile_number']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" name="telephone_number" id="telephone_number" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerDetails'][0]['phone_number']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
								</div>	
							</div>
...
" class="new_container_content_class"> <!-- Parent div 0 Start -->
												<div class="col-md-12" >		
													...
													<div class="col-md-6">
														<input type="text" name="container_type" id="container_type" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerContainerdetails'][$this->_sections['cart']['index']]['container_type']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
													</div>
													...
													<div class="col-md-6">
														<input type="text" name="container_number" id="container_number" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerContainerdetails'][$this->_sections['cart']['index']]['container_number']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
													</div>
													...
													<div class="col-md-6">
													<input type="text" name="postcode" id="contract_start_date" disabled="contract_start_date" value="<?php echo $this->_tpl_vars['CustomerContainerdetails'][$this->_sections['cart']['index']]['contract_start_date']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
													</div>
													...
													<div class="col-md-6">
													<input type="text" name="contract_due_date" id="contract_due_date" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerContainerdetails'][$this->_sections['cart']['index']]['contract_start_date']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
													</div>
...
uploads/address_proof/<?php echo $this->_tpl_vars['get_address_proof_res']; ?>
" download > 
												<img width="220"  src="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
images/download_address_proof.PNG" title="Address Proof" class="downloadable" style="cursor:pointer;" />
												</a>
												</label>
											</div>	
												
											<div class="col-md-12" style="display:none">
											<input type="hidden" name="fullapth" id="fullapth" value="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
uploads/address_proof/" />
											<input type="hidden" name="checkset" id="getresult" value="<?php echo $this->_tpl_vars['get_address_proof_res']; ?>
" />
											</div>
											...
											<div class="col-md-12">
										 	<input type="hidden" name="fullapth_id" id="fullapth_id" value="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
uploads/id_proof/" />
											<input type="hidden" name="getproofresult" id="getproofresult" value="<?php echo $this->_tpl_vars['get_id_proof_res']; ?>
" />
											<a style="position:relative; cursor:pointer; right:20px;" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
uploads/id_proof/<?php echo $this->_tpl_vars['get_id_proof_res']; ?>
" download > 
												<img width="220"  src="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
images/download_id_proof.PNG" title="ID Proof" class="downloadable" style="cursor:pointer;" />
												</a>
											</div>
...
">
												...
												<div class="col-md-6">
													 	<input type="text" name="authorized_user_name" id="authorized_user_name" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerAuthordetails'][$this->_sections['author']['index']]['authorized_user_name']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
												</div>
												...
												<div class="col-md-6">
													<input type="text" name="authorized_user_mobile_number" id="authorized_user_mobile_number" disabled="disabled" value="<?php echo $this->_tpl_vars['CustomerAuthordetails'][$this->_sections['author']['index']]['authorized_user_mobile_number']; ?>
"  class="form-control" style=' overflow: hidden; margin-bottom: 5px;display: inline-block;margin-left: 5px;'  />
													</div>
									...
									<!--<div class="form-group">
											...
											<div class="col-md-12">
												<div class="col-md-12 col-md-offset-3">
													...
													<label for="exampleInputEmail1">
												<a class="btn btn-block btn-primary" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
uploads/license_agreement/<?php echo $this->_tpl_vars['filename_license_agreement']; ?>
" download > 
...
images/download_id_proof.PNG" title="ID Proof" class="downloadable" style="cursor:pointer;" />-->
												<!--</a>-->
													...
													<!--<img width="30" style="position:relative; right:20px;" src="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
images/download_expenses.png" title="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
uploads/license_agreement/<?php echo $this->_tpl_vars['filename_license_agreement']; ?>
" class="downloadable_license"/> View License Agreement-->
