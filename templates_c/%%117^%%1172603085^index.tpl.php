<?php /* Smarty version 2.6.2, created on 2016-10-08 13:57:28
...
AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
    <link href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
...
"><img class="img-responsive" src="<?php echo $this->_tpl_vars['siteadmin_imagepath']; ?>
logo.PNG"></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form name="loginfrm" id="loginfrm" method="post" onSubmit="return validatelogin();">
          ...
          <div class="form-group has-feedback">
						<?php if ($this->_tpl_vars['logerrmsg'] != ''): ?>
						<label for="inputError" class="control-label" style="color:#FF0000;" ><i class="fa fa-times-circle-o"></i> <?php echo $this->_tpl_vars['logerrmsg']; ?>
</label>
						<?php endif; ?>
...
plugins/jQuery/jQuery-2.1.4.min.js" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?php echo $this->_tpl_vars['siteadmin_scriptpath']; ?>
...
common.js" type="text/javascript"></script>
	...
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['siteadmin_scriptpath']; ?>
source/jquery.fancybox.js?v=2.1.5"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['siteadmin_scriptpath']; ?>
