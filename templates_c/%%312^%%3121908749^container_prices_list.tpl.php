<?php /* Smarty version 2.6.2, created on 2016-10-07 16:41:52
         compiled from container_prices_list.tpl */ ?>
...
container_prices.php" title="Create Container Price"  class="btn bg-primary btn-primary margin">
									Create Container Price
						</a>

						<!--<a class="new_admin_class" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
container_prices.php" title="Create Container Price"><i class="glyphicon glyphicon-plus" style="font-size:28px;color:green;"></i></a>-->
