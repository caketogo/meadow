<?php /* Smarty version 2.6.2, created on 2016-06-20 03:36:20
					...
					<form name="frmsettings" id="frmsettings" role="form" method="post">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="txt_field" id="txt_field" placeholder="Field" value="<?php echo $this->_tpl_vars['SettingsEditDetails'][0]['field']; ?>
" required/>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Value :</label>
								<input type="text" class="form-control" name="txt_value" id="txt_value" placeholder="Value" value="<?php echo $this->_tpl_vars['SettingsEditDetails'][0]['value']; ?>
" required/>
							</div>
