<?php /* Smarty version 2.6.2, created on 2016-10-07 16:44:46
...
create_customer.php" title="Create Customer" class="btn bg-primary btn-primary margin">
									Create Customer
							</a>
...
create_customer.php" title="Create Customer"><i class="glyphicon glyphicon-plus" style="font-size:28px;color:green;"></i></a>-->
							</div>	
						</div>
					</div>
