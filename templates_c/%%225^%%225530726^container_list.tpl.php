<?php /* Smarty version 2.6.2, created on 2016-10-08 02:40:27
         compiled from container_list.tpl */ ?>
...
create_container.php" title="Create Manual Container"  class="btn bg-primary btn-primary margin">
									Add a Container	
						</a>
						<a  href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
import_container.php" title="Import CSV Container"  class="btn bg-primary btn-primary margin">
									Import Containers
						</a>
...
create_container.php" title="Create Manual Container"><i class="glyphicon glyphicon-plus" style="font-size:28px;color:green;"></i></a>
						<a class="new_admin_class" href="<?php echo $this->_tpl_vars['siteadmin_globalpath']; ?>
import_container.php" title="Import CSV Container"><i class="glyphicon glyphicon-import" style="font-size:28px;color:green;"></i></a>-->
						</div>	
						</div>
					</div>
