...
if(isset($_REQUEST['hdAction']) && $_REQUEST['hdAction'] == 2) {
	...
	$objTemplate->DeleteTemplateDetails($_REQUEST['templid']);
}
...
$TemplateList = $objTemplate->GetTemplateDetails($PerPage, $Page, $Display, $_REQUEST);

$objSmarty->assign("TemplateList",$TemplateList);
$objSmarty->assign('pgnametitle',	'Template List');

$objSmarty->assign('emailtemplate1',	'1');
$objSmarty->assign('emailtemplate2',	'1');

$objSmarty->display("template_list.tpl");
?>