				...
				<div class="box box-primary">
					...
					<div class="row" >
							...
							<div class="col-md-12 ">
								...
								<div class="col-md-6">
									<h2 class="box-title">Process a Payment - {$Customer_full_name}</h2>
								</div>
								<!--<div class="col-md-4">
				...
				<div class="box-body table-responsive">
					<table id="openTrigger" class="table table-striped table-bordered">
                        ...
                        {section name="payment" loop=$PaymentHistoryList}
							...
							<!-- <br />-->
                          <tr>
                           <!-- <td width="2%"  class="text-center"><input type="checkbox" class="case" name="select_{$PaymentHistoryList[payment].container_number}" id="select_{$PaymentHistoryList[payment].container_number}" value="{$ProjectList[project].project_id}" /></td>-->
							...
							<td width="20%">
							<input type="text" name="related_date[]" readonly="" id="related_date_{$PaymentHistoryList[payment].id}" value="{$PaymentHistoryList[payment].Related_priod_Result}" style="min-width: 75%; border:none" />	
							</td>
							<td width="5%">{$PaymentHistoryList[payment].overdue}</td>
							<td width="5%">&pound; {$PaymentHistoryList[payment].licence_amount_vat}</td>
                            <td width="5%">&pound; {$PaymentHistoryList[payment].deposit_amount}</td>
							<td width="7%">&pound; {$PaymentHistoryList[payment].miscellaneous}</td>
							<td width="7%">{$PaymentHistoryList[payment].penality}</td>
							<td width="7%">&pound; {$PaymentHistoryList[payment].totalAmountDueColumn}</td>
							<td width="5%"><select name="total_month" id="total_month" onchange="makeTotalDueAmount(this.value, '{$PaymentHistoryList[payment].id}')">
							...
							<td width="35%" id="total_amount_due">&pound; <input type="text" style="width:79%; border:none; " id="total_amount_due_lmdp_{$PaymentHistoryList[payment].id}" name="total_amount_due_lmdp" disabled="disabled" value="{$PaymentHistoryList[payment].totalAmountDueColumn}" readonly="" /></td>
                          </tr> 
                        {sectionelse}
                          <tr>
