					...
					<form name="frmsettings" id="frmsettings" role="form" method="post" enctype="multipart/form-data" onsubmit="return checkUpload();">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<br />
									<span id="lblError_new" style="padding-top: 10px; color:#666666"><a style="color: #999999" href="{$siteadmin_globalpath}sample-csv.csv" title="Sample CSV">Sample CSV file [Comma separated...]</a></span>
