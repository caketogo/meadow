					...
					<div class="row" >
						<div class="col-md-12 ">
								...
								<div class="col-md-6" style="margin:10px 0 0 0">
									<a  href="{$siteadmin_globalpath}create_expenses.php" title="Create Expenses" class="btn bg-primary btn-primary margin">
											Create Expenses
									</a>
									...
									<!--<a class="new_admin_class" href="{$siteadmin_globalpath}create_expenses.php" title="Create Expenses"><i class="glyphicon glyphicon-plus" style="font-size:28px;color:green;"></i></a>-->
								</div>	
